...
export default function MenuDescriptionSection() {
	return (
		<MenuDescriptionWrapper>
			...
			<Description>
				닭, 오리, 돼지. 촉촉하게 구운 싱가포르식 닭과 오리. 그리고 차슈. 껍질을 바삭하게 구운 돼지바베큐.
				다 구워, 먹기 좋게 썰어 나오고, 찬요리로 나오니 기다릴 필요가 없다. 성수에는 없는 덤플링이 있어
				맛볼 수 있다. 와인도 백주도 맥주도 잘 어울리는 안주. 밥과 누들을 곁들이면 식사로도 손색이 없다.
			</Description>
